 ...
 * — covers both true adhoc templates and scheduled recurring parents)
 * has a checklist that's really just the template copied onto every
 * spawned instance, not real live work. Those tasks are excluded from
 * this register entirely, same as masters are excluded from every other
 * "real gig" surface (Timesheet, Weekly Report, Gig Index's default
 * scopes).
 */
