 ...
 * Reward columns removed — pricing is a separate module.
 * Gig picker shows category from project_categories join.
 */
  ...
  grid.innerHTML = visible.map(g => {
    ...
    return `
      <div onclick="selectGig('${g.gig_id}')" style="
        ...
        <div style="font-size:11px;color:rgba(247,246,242,0.4);margin-bottom:10px;">${esc(catCode || 'Uncategorised')}</div>
